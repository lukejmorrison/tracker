...
//#region node_modules/.nitro/vite/services/ssr/assets/router-7-FUcM5U.js
var router_7_FUcM5U_exports = /* @__PURE__ */ __exportAll({
	a: () => formatInt,
	c: () => GROK_PROVIDERS,
	getRouter: () => getRouter,
	i: () => cn,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [NAV.map((item) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: item.to,
								className: cn("rounded-sm px-2.5 py-2 text-sm transition-colors duration-150 sm:px-3", active ? "text-fg" : "text-muted hover:text-fg"),
								children: item.label
							}, item.to);
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mx-auto flex max-w-6xl flex-col gap-2 px-4 py-8 text-xs text-subtle sm:flex-row sm:items-center sm:justify-between sm:px-6",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Compiled from the open-source X algorithm and X Transparency Reports." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Not an official X product. Individual withheld posts are still not public." })]
				})
			})
		]
	});
...
function AuthSlot() {
	const { user, isPending } = useCurrentUserState();
	if (isPending) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ml-1 size-8 animate-pulse rounded-full bg-raised" });
...
var styles_default = "/assets/styles-DksbSIdl.css";
var APP_NAME = "tracker.grok.me";
var Route$6 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "See what governments require X to hide — by country. Open-source algorithm filters, national blocks, and transparency-report demand."
			},
			{
...
var $$splitComponentImporter$4 = () => import("./routes-Qb6NJTJV.mjs");
var Route$5 = createFileRoute("/")({
	validateSearch: (raw) => ({
		q: typeof raw.q === "string" ? raw.q : void 0,
		region: typeof raw.region === "string" ? raw.region : void 0,
		status: typeof raw.status === "string" ? raw.status : void 0
	}),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./filters-B8X2f9nv.mjs");
var Route$4 = createFileRoute("/filters")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./login-BweDW6sw.mjs");
var Route$3 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./sources-Cfe-KSQi.mjs");
var Route$2 = createFileRoute("/sources")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./country._code-BeDwqA6m.mjs");
var Route$1 = createFileRoute("/country/$code")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
...
var rootRouteChildren = {
	...
	CountryCodeRoute: Route$1.update({
		id: "/country/$code",
		path: "/country/$code",
		getParentRoute: () => Route$6
	}),
...
//#endregion
export { formatInt as a, signIn as c, cn as i, Route$1 as n, formatPct as o, Route$5 as r, router_7_FUcM5U_exports as s, GROK_PROVIDERS as t };
